...
define('PRODUCTION_CERTIFICATE_KEY', __DIR__ . '/applepay_includes/ApplePay.key.pem');
define('PRODUCTION_CERTIFICATE_PATH', __DIR__ . '/applepay_includes/ApplePay.crt.pem');

// This is the password you were asked to create in terminal when you extracted ApplePay.key.pem
define('PRODUCTION_CERTIFICATE_KEY_PASS', '1234');
...
define('PRODUCTION_DISPLAYNAME', 'Test git');
